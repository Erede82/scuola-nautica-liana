...
abstract final class SchoolBackofficeDemoData {
  ...
  static BackofficeDemoSeed cloneSeedForMutableStore() {
    return BackofficeDemoSeed(
      ...
      documents: List<StudentDocument>.from(_documents),
      photos: List<StudentPhoto>.from(_photos),
    );
  }
  ...
  static final Map<StudentId, PracticeLicenseDossier> _practice = {
    demoStudentLucia: PracticeLicenseDossier(
      ...
      registrationDate: DateTime(2026, 3, 10),
      registryYear: 2026,
      registryNumber: 2,
      registryCode: '2026/00002',
      practiceNumber: 'PR-2026-8891',
      licenseNumber: null,
      documentStatus: LicenseDocumentStatus.notStarted,
      practiceStatus: PracticeFileStatus.waitingDocuments,
      authorityNotes: 'Checklist demo: documenti obbligatori incompleti.',
    ),
    demoStudentMarco: PracticeLicenseDossier(
      id: 'prac-marco-01',
      studentId: demoStudentMarco,
      practiceType: 'renewal',
      registrationDate: DateTime(2026, 4, 5),
      practiceNumber: 'PR-2026-1204',
  ...
  /// Documenti demo per checklist (valori DB camelCase).
  static final List<StudentDocument> _documents = [
    StudentDocument(
      id: 'doc-lucia-ci',
      studentId: demoStudentLucia,
      practiceDossierId: 'prac-lucia-01',
      documentType: 'identityCard',
      title: 'Carta identità Lucia Bianchi',
      storagePath: 'mock/student-documents/lucia/ci.pdf',
      fileName: 'ci.pdf',
    ...
    StudentDocument(
      ...
      storagePath: 'mock/student-documents/lucia/cf.pdf',
      fileName: 'cf.pdf',
      mimeType: 'application/pdf',
      status: 'uploaded',
      createdAt: DateTime(2026, 3, 11),
    ...
    StudentDocument(
      id: 'doc-lucia-med-expired',
      studentId: demoStudentLucia,
      practiceDossierId: 'prac-lucia-01',
      documentType: 'medicalCertificate',
      title: 'Certificato medico sportivo',
      storagePath: 'mock/student-documents/lucia/medico.pdf',
      fileName: 'medico.pdf',
      mimeType: 'application/pdf',
      status: 'expired',
    ...
    StudentDocument(
      id: 'doc-marco-ci',
      studentId: demoStudentMarco,
      practiceDossierId: 'prac-marco-01',
      documentType: 'identityCard',
      title: 'Carta identità Marco Verdi',
      storagePath: 'mock/student-documents/marco/ci.pdf',
      fileName: 'ci.pdf',
      mimeType: 'application/pdf',
      status: 'uploaded',
    ...
    StudentDocument(
      ...
      storagePath: 'mock/student-documents/marco/cf.pdf',
      fileName: 'cf.pdf',
      mimeType: 'application/pdf',
      status: 'uploaded',
      createdAt: DateTime(2026, 4, 6),
    ...
    StudentDocument(
      id: 'doc-marco-med-soon',
      studentId: demoStudentMarco,
      practiceDossierId: 'prac-marco-01',
      documentType: 'medicalCertificate',
      title: 'Certificato medico rinnovo',
      storagePath: 'mock/student-documents/marco/medico.pdf',
      fileName: 'medico.pdf',
      mimeType: 'application/pdf',
      status: 'uploaded',
  ...
  static final List<StudentPhoto> _photos = [
    StudentPhoto(
      id: 'photo-lucia-profile',
      studentId: demoStudentLucia,
      photoKind: 'profile',
      storagePath: 'mock/student-photos/lucia/profile.jpg',
    ...
    StudentPhoto(
      id: 'photo-lucia-signature',
      studentId: demoStudentLucia,
      photoKind: 'other',
      notes: 'Firma',
      storagePath: 'mock/student-photos/lucia/firma.png',
      fileName: 'firma.png',
      mimeType: 'image/png',
      createdAt: DateTime(2026, 3, 12),
      updatedAt: DateTime(2026, 3, 12),
    ...
    StudentPhoto(
      id: 'photo-marco-license',
      studentId: demoStudentMarco,
      photoKind: 'license',
      storagePath: 'mock/student-photos/marco/patente.jpg',
      fileName: 'patente.jpg',
      mimeType: 'image/jpeg',
      createdAt: DateTime(2026, 4, 6),
      updatedAt: DateTime(2026, 4, 6),
    ),
